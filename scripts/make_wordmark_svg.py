...
# ---- geometry / grid ------------------------------------------------------
COLS = int(os.environ.get("WORDMARK_COLS", 170))
...
TEXT = os.environ.get("WORDMARK_TEXT", "TELES")
...
DEPTH_FRAC = 0.22      # extrusion depth as a fraction of glyph height. lower than the
                       # 3-letter default: TELES's 5 letters leave thinner counters (the
                       # gaps between an E's bars), and a deeper wall bleeds into them,
                       # fusing the bars into a solid block. shallower walls survive.
